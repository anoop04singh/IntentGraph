...
test('playground pays once, refreshes actual tools, returns query data and keeps proof out of model and public trace', async () => {
 ...
 assert.equal(events.find(e=>e.type==='answer')?.text,'Query result received.');
